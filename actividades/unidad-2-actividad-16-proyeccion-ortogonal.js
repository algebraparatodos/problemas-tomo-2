<!-- ============================================================
     ÁLGEBRA PARA TODOS · Actividad "Proyección ortogonal" (Unidad 2)
     ------------------------------------------------------------
     Dado un conjunto generador de S y un vector x, encontrar la
     proyección ortogonal de x sobre S. Respuesta ÚNICA y exacta ->
     usa space-basis con exactMatch:true (v2.5, nuevo). Producto
     escalar estándar sobre coordenadas canónicas.
     ============================================================ -->

<div id="apt-proyeccion-mount"></div>

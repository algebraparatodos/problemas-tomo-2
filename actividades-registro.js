...
(function (global) {
  ...
  var MANIFIESTO = [
    ...
    { id: 'u1a2', unidad: 1, n: 2 , titulo: 'Matriz ampliada',                                     modo: 'grid',         archivo: 'unidad-1-actividad-2-matriz-ampliada.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u1a3', unidad: 1, n: 3 , titulo: '¿Es escalonada?',                                     modo: 'choices',      archivo: 'unidad-1-actividad-3-escalonada.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u1a4', unidad: 1, n: 4 , titulo: 'Aplicá el método de eliminación de Gauss',            modo: 'grid',         archivo: 'unidad-1-actividad-4-metodo-de-gauss.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u1a5', unidad: 1, n: 5 , titulo: '¿Es escalonada reducida?',                            modo: 'choices',      archivo: 'unidad-1-actividad-5-escalonada-reducida.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    ...
    { id: 'u1a11', unidad: 1, n: 11, titulo: 'Tipos de matrices',                                   modo: 'multiselect',  archivo: 'unidad-1-actividad-11-tipos-de-matrices.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u1a12', unidad: 1, n: 12, titulo: 'Suma de matrices',                                    modo: 'choices',      archivo: 'unidad-1-actividad-12-suma-de-matrices.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u1a13', unidad: 1, n: 13, titulo: 'Producto de una matriz por un escalar',               modo: 'choices',      archivo: 'unidad-1-actividad-13-producto-por-escalar.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u1a14', unidad: 1, n: 14, titulo: 'Trasposición de matrices',                            modo: 'choices',      archivo: 'unidad-1-actividad-14-trasposicion.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u1a15', unidad: 1, n: 15, titulo: 'Producto de matrices',                                modo: 'choices',      archivo: 'unidad-1-actividad-15-producto-de-matrices.js',
      unidadTitulo: 'Unidad 1: Matrices y SEL' },
    { id: 'u2a1', unidad: 2, n: 1 , titulo: 'Operaciones con conjuntos',                           modo: 'choices',      archivo: 'unidad-2-actividad-1-operaciones-con-conjuntos.js',
      unidadTitulo: 'Unidad 2: Subespacios vectoriales' },
    { id: 'u2a2', unidad: 2, n: 2 , titulo: '¿Es una LCI?',                                        modo: 'choices',      archivo: 'unidad-2-actividad-2-es-lci.js',
      unidadTitulo: 'Unidad 2: Subespacios vectoriales' },
    { id: 'u2a3', unidad: 2, n: 3 , titulo: '¿Es una LCE?',                                        modo: 'choices',      archivo: 'unidad-2-actividad-3-es-lce.js',
      unidadTitulo: 'Unidad 2: Subespacios vectoriales' },
    { id: 'u2a4', unidad: 2, n: 4 , titulo: 'Neutro y simétrico de una operación "rara"',          modo: 'grid',         archivo: 'unidad-2-actividad-4-neutro-y-simetrico.js',
      unidadTitulo: 'Unidad 2: Subespacios vectoriales' },
    { id: 'u2a5', unidad: 2, n: 5 , titulo: '¿Es un subespacio vectorial?',                        modo: 'choices',      archivo: 'unidad-2-actividad-5-es-sev.js',
      unidadTitulo: 'Unidad 2: Subespacios vectoriales' },
    { id: 'u2a6', unidad: 2, n: 6 , titulo: '¿Es LI o LD?',                                        modo: 'choices',      archivo: 'unidad-2-actividad-6-son-li.js',
      unidadTitulo: 'Unidad 2: Subespacios vectoriales' },
    { id: 'u2a7', unidad: 2, n: 7 , titulo: '¿Genera V? ¿Es base?',                                modo: 'choices',      archivo: 'unidad-2-actividad-7-genera-s.js',
      unidadTitulo: 'Unidad 2: Subespacios vectoriales' },
    ...
    { id: 'u3a8', unidad: 3, n: 8 , titulo: 'Matriz asociada en otras bases',                      modo: 'grid',         archivo: 'unidad-3-actividad-8-matriz-asociada.js',
      unidadTitulo: 'Unidad 3: Transformaciones Lineales' },
    { id: 'u3a9', unidad: 3, n: 9 , titulo: 'Cambio de base de M(T)',                              modo: 'choices',      archivo: 'unidad-3-actividad-9-cambio-base-matriz-asociada.js',
      unidadTitulo: 'Unidad 3: Transformaciones Lineales' },

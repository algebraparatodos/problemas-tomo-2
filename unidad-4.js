/* ============================================================
   ÁLGEBRA PARA TODOS · Unidad 4 · Diagonalización — índice y ruteo
   ------------------------------------------------------------
   UNA sola landing de Kajabi para TODAS las actividades de la
   unidad. El número de actividad viaja en el fragmento de la URL:

     .../qrt2u4#7   → abre directamente la actividad 7
     .../qrt2u4     → muestra la grilla "Elegí el QR"
   ...
   En la landing de Kajabi va únicamente esto:
     ...
     <script src="https://algebraparatodos.github.io/problemas-tomo-2/unidad-4.js"><\/script>
